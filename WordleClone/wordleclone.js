...
document.addEventListener("keydown", function(keypress) {
    if (gameWon === false) {
        if (/[A-Za-z]/.test(keypress.key)) { //filters out numbers + special characters
            ...
            else if (keypress.key === "Backspace" || keypress.key === "Tab") { //prevents backspace from deleting the value in the previous box & tab from moving the focus to another box
